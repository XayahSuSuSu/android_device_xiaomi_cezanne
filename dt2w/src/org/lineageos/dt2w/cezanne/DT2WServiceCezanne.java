package org.lineageos.dt2w.cezanne;
...
public class DT2WServiceCezanne extends Service {
    private static final String TAG = "DT2WServiceCezanne";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.cezanne.dt2w", dt2wEnabled ? "1" : "0");
        }
